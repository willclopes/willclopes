### Oi, eu sou o Willian <a href="https://github.com/willclopes"><img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="25px"></a>
...
|Tema Projeto|Descrição|Link do Projeto|Preview Projeto(s)
|:-:|:-:|:-:|:-:|
|EDA|A Análise Exploratória de Dados é uma abordagem de análise no conjuntos de dados para resumir suas características principais, geralmente usando gráficos estatísticos e outros métodos de visualização de dados.|<a href="https://github.com/willclopes/Portfolio-Data-Science/blob/master/EDA"><img alt="All Repositories" title="Repositories" src="https://custom-icon-badges.herokuapp.com/badge/-All%20Repos-2962FF?style=for-the-badge&logoColor=white&logo=repo"/></a>|[Analise de vendas de gadgets](https://github.com/willclopes/Portfolio-Data-Science/blob/master/4_EDA_Analise_de_vendas_de_gadgets.ipynb)|
